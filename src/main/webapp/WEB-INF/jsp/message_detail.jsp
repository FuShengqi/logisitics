                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="form-group">
                            ...
                            <span>留言人姓名：${message.userName}</span> &nbsp;&nbsp; <span>留言时间：${message.msgDate.toLocaleString()}</span> &nbsp;&nbsp; <span id="status">状态：未回复</span>
                            <span class="hidden" id="uuid">${message.uuid}</span>
                        </div>
                    ...
                    <div class="form-group">
                        <textarea  id="response_content" class="form-control" name="msgContent" rows="6" placeholder="您的回复"></textarea>
                    </div>
                    <div class="form-group text-center">
                        <a class="btn btn-primary" id="response">回复</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(function () {
        $("#response").click(function () {
            ...
            var responseContent = $("#response_content").val();
            responseContent = encodeURI(encodeURI(responseContent));
            var uuid = $("#uuid").text();
            uuid = $.trim(uuid);
            ...
            $.ajax({
                ...
                url : "response?"+"responseContent=" + responseContent + "&" + "uuid=" + uuid,
